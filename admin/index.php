...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  <a class="navbar-brand" href="index.php"><img src="images/download.jpeg" style="width: 150px;" alt=""></a>
  ...
  <div class="navbar-collapse collapse justify-content-end" id="navbarSupportedContent">
    ...
    <ul class="nav navbar-nav ">
      ...
      <li class="nav-item"><a class="nav-link" href="index.php?page=add-student"><i class="fa fa-user-plus"></i> Add Stuennt</a></li>
      <li class="nav-item"><a class="nav-link" href="index.php?page=ass"><i class="fa fa-user"></i> Ass</a></li>
